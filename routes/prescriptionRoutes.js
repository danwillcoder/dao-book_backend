...
router.get(
  "/prescription/session/:sessionId",
  mustBePracOrPatient,
  verifyOwnership(Session, "sessionId"),
  prescriptionController.getPrescriptionsBySessionId
);
router.get("/prescriptions/prac/:pracId", prescriptionController.getPrescriptionsByPracId);
router.get(
  "/prescriptions/patient/:patientId",
  mustBePracOrPatient,
  verifyOwnership(Prescription, "patientId"),
